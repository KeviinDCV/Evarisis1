---
name: data-auditor
description: Valida la precisión de datos médicos oncológicos con AUDITORÍA SEMÁNTICA INTELIGENTE. Detecta falsa completitud, valida TODOS los campos críticos (biomarcadores + DIAGNOSTICO_COLORACION + DIAGNOSTICO_PRINCIPAL + FACTOR_PRONOSTICO + IHQ_ORGANO). Usa cuando el usuario mencione 'auditar', 'validar', 'verificar', reporte campos sospechosos, o después de procesar PDFs.
...
## 🚀 CAPACIDADES PRINCIPALES (v2.0.0)

### 1. DETECCIÓN SEMÁNTICA INTELIGENTE
...
- **NOTA v6.1.0:** Columna DIAGNOSTICO_COLORACION ahora existe en BD (posición 30/130)
...
- **Qué valida:**
  - Contiene SOLO biomarcadores IHQ
