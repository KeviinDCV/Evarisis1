...
Versión: 4.2.6 - FIX case-sensitivity en separación biomarcadores
...
def extract_biomarcadores_solicitados_robust(text: str) -> List[str]:
    ...
    patrones_biomarcadores = [
        # Patrón -2: V6.0.14 - "se realiza marcación para [lista]" (IHQ250992)
        # Específico para casos con bloque previo donde se decide realizar marcación
        r'se\s+realiza\s+marcaci[óo]n\s+para\s+([A-Z0-9\s,./\-\(\)yYóÓúÚáÁéÉíÍ]+?)\.',
