...
Versión: 4.2.7 - FIX CRÍTICO prioridad FALLBACK en mapeo BD
Fecha: 27 de octubre de 2025 (MADRUGADA)
...
def extract_ihq_data(text: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if biomarker_data:
            ...
            # quedó vacío/NO APLICA por problemas de formato en PDF
            factor_actual = combined_data.get('Factor pronostico', '').strip()
            if not factor_actual or factor_actual in ['NO APLICA', 'N/A', 'SIN DATO']:
                try:
