...
def extract_diagnostico_coloracion(text: str) -> str:
    ...
    """
    if not text:
        # Patrón para material extrainstitucional
...
def parse_biomarkers_from_factor_pronostico(factor_pronostico: str) -> Dict[str, str]:
    ...
    for par in pares:
        ...
        # V6.0.19: Normalizar unicode para ignorar tildes (ESTRÓGENO → ESTROGENO)
        # Solución para IHQ250980: permite detectar "ESTRÓGENO" buscando "ESTROGEN"
        nombre_normalizado = unicodedata.normalize('NFKD', nombre_upper)
        ...
        elif 'RECEPTOR' in nombre_normalizado and 'PROGR' in nombre_normalizado:
            # Captura: PROGRESTERONA, PROGESTERONA, PROGEST, etc.
            columna = 'IHQ_RECEPTOR_PROGESTERONA'
        elif 'HER' in nombre_normalizado and '2' in nombre_normalizado:
            columna = 'IHQ_HER2'
        elif 'KI' in nombre_normalizado and '67' in nombre_normalizado:
            columna = 'IHQ_KI-67'
        else:
