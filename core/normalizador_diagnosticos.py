...
CATEGORIAS_DIAGNOSTICO: dict[str, list[str]] = {
    ...
    "NEOPLASIA BENIGNA / TUMOR NO MALIGNO": [
        ...
        "MESOTELIOMA", "PTERIGION", "CONDILOMA", "VITILIGO",
    ...
    "SIN DIAGNOSTICO EN TEXTO / REVISAR (EXTRACCION)": [
        ...
        "EN CURSO", "HALLAZGOS MORFOLOGICOS Y DE INMUNOHSITOQUIMICA",
        ...
        "GANGLIO LINFATICO", "GANGLIOS LINFATICOS", "INJERTO RENAL", "ENDOSCOPICA",
    ...
    "PROLIFERACION ATIPICA / A CLASIFICAR": [
        ...
        "INFLAMACION CRONICA CON PREDOMINIO",
    ],
}
