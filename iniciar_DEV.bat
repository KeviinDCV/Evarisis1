@echo off
color 0E
title EVARISIS [MODO DESARROLLO UI - BD COPIA, NO PRODUCCION]
echo.
echo ================================================================================
echo            EVARISIS - MODO DESARROLLO DE INTERFAZ (UI/UX)
...
set "EVARISIS_DB_OVERRIDE=%WORK_DIR%data\huv_oncologia_DEV.db"

REM Encoding UTF-8 para logs completos
set PYTHONIOENCODING=utf-8
set PYTHONUTF8=1

echo BD activa (desarrollo): %EVARISIS_DB_OVERRIDE%
echo.
...
echo.
"%VENV_PATH%\Scripts\python.exe" ui.py --lanzado-por-evarisis --nombre "DESARROLLO UI" --cargo "Diseno UI-UX" --tema "huv" --modo-independiente 2>&1
